...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addTransform("playground-embed", function (content) {
    ...
    const style = [
      ...
      ".pg-tab{padding:2px 10px;font-size:13px;font-weight:500;cursor:pointer;border:none;background:transparent;color:#333;font-family:inherit;}",
      ".pg-tab:hover{color:#B8382F;}.pg-tab.active{color:#B8382F;}",
      ".pg-body{display:flex;height:250px;}",
      ...
      ".pg-editor{width:100%;height:100%;font-size:13px;}",
